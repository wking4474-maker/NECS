...
pure-pw useradd ftp1 -u ftpuser -g ftpuser -d /home/ftpuser/ftp1  (给ftp1用户密码)
pure-pw useradd ftp2 -u ftpuser -g ftpuser -d /home/ftpuser/ftp2  (给ftp2用户密码)
pure-pw mkdb /etc/pureftpd.pdb
vi /opt/pure-ftpd-1.0.52/pure-ftpd.conf
...
chmod +x /etc/ban.sh 
pure-uploadscript -r /etc/ban.sh
```